...
if (positionals.length > 1) fail(`unexpected extra argument ${JSON.stringify(positionals[1])}; try --help`)
const rootArg = positionals[0]

if (rootArg !== undefined && rootArg.startsWith('-')) fail(`unknown flag ${JSON.stringify(rootArg)}; try --help`)
